...
def call_audio_server():
#    p = subprocess.call(['python','mic_server.py'],stdout=PIPE, stderr=PIPE)
    proc = Popen (['python','mic_server.py'],shell=True,stdin=None,stdout=None,stderr=None,close_fds=True)
    # proc.communicate()
    print ("Child server process successfully generated")
